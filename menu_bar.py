...
class MenuBar(object):
    ...
    def __init__ (self, master):
        ...
        self.file_menu_ops.add_command(label="Nouveau")
        self.file_menu_ops.add_command(label="Ouvrir", command=self.open_file)
        self.file_menu_ops.add_command(label="Enregistrer sous",
                                       state="disabled",
